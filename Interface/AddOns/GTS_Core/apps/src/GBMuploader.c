//GBMuploader v3.0b1 part of
//GuildToolS package v3.0b1
...
int GBMupload(int argc, char **argv){
  ...
  int newowner=0;
  //bank
  char num[100], name[100], desc[5000], pic[100], type[100], id[10], subtype[100], owner[20];
  ...
  for (i=1; i<argc; i++)
  {
    ...
    if (strcmp(argv[i],"-?")==0 || strcmp(argv[i],"-help")==0)
    {
      ...
      printf("-name <string> - sets the location of SV.lua file.\n");
  ...
  while (strncmp(buf, "}", 1)!=0)
  {
             ...
             if (strstr(buf,"[\"")!=NULL && strstr(buf,"\"]")!=NULL)
             {
               ...
               while (strncmp(buf, "},", 2)!=0)
               {
                 ...
                 if (newowner==1)
                 {
                   ...
                   sprintf(link, "DELETE FROM `items` WHERE owner='%s';",owner);
                 ...
                 {                 
                   ...
                   link[0]='\0';
                   strcat(link, "INSERT INTO `items` ( `id` , `name` , `itemid`");
                   ...
                   strcat(link,"<table bgcolor=\"#FFFFAA\" width=190 cellpadding=3 ");
                   strcat(link,"cellspacing=0 border=0 valign=top align=left>");
                   strcat(link, "<tr><td><span style=\"font-size: 12px;");
                   if (quality==0) strcat(link,"color:#5F5F5F;\"><b>");
                   if (quality==1) strcat(link,"color:#000000;\"><b>");
                   if (quality==2) strcat(link,"color:#00AF00;\"><b>");
                   if (quality==3) strcat(link,"color:#0000FF;\"><b>");
                   if (quality==4) strcat(link,"color:#BF00BF;\"><b>");
                   if (quality==5) strcat(link,"color:#DD8800;\"><b>");
                   strcat(link, name);
                   strcat(link,"</b></span><span style=\"font-size: 12px; color:black\">");
                   strcat(link, desc);
             ...
             if (strstr(buf,"[\"")!=NULL && strstr(buf,"\"]")!=NULL)
             {
               ...
               while (strncmp(buf, "},", 2)!=0)
               {
                 ...
                 if (strncmp(buf, "},", 2)==0 && name[0]!='\0')
                 {
                   ...
                   //Creates an sql statement to add the item into DB
                   link[0]='\0';
                   strcat(link, "INSERT INTO `imail` ( `id` , `name` , `itemid`");
                   strcat(link, " , `quality` , `icon` , `tooltip` , `stock` ,");
                   strcat(link, " `type` , `subType` , `g` , `s`, `c` , `owner`,");
    ...
    {  
             ...
             if (strstr(buf,"[\"")!=NULL)
             {
               ...
               while (strncmp(buf, "},", 2)!=0)
               {
                 ...
                 if (newowner==1)
                 {
                   ...
                   sprintf(link, "UPDATE members SET flag=1;");
                   printf("Executing: %s ... ",link);
                   totalq++;
                   sucq++;
                 ...
                 if (strncmp(buf, "},", 2)==0 && name[0]!='\0')
                 {
                   ...
                   if (asd<=0) 
                   {
                     strcat(link, "INSERT INTO `members` ( `id` , `name` , `class`");
                   ...
                   {
                     strcat(link, "UPDATE `members` SET `name`='");
                     strcat(link, name);
                     strcat(link, "', `class`='");
                     strcat(link, clas);
                     strcat(link, "', `lvl`='");
       ...
       sprintf(link, "UPDATE members SET flag=2 WHERE flag=1;");
       printf("Executing: %s ... ",link);
       totalq++;
       sucq++;
             ...
             if (strstr(buf,"[\"")!=NULL && strstr(buf,"\"]")!=NULL)
             {
               ...
               while (strncmp(buf, "},", 2)!=0)
               {
                 ...
                 if (strncmp(buf, "},", 2)==0 && name[0]!='\0')
                 {
                   ...
                   //Creates an sql statement to add the item into DB
                   link[0]='\0';
                   strcat(link, "INSERT INTO `omail` ( `id` , `name` , `itemid`");
                   strcat(link, " , `quality` , `icon` , `tooltip` , `stock` ,");
                   strcat(link, " `type` , `subType` , `g` , `s`, `c` , `owner`,");
  ...
  for (i=0; i<numbankers; i++)
  {
    ...
    {
      sprintf(query,
      "INSERT INTO bmembers (`id`, `name`, `g`, `s`, `c`, `ldate`) VALUES ('', '%s', '%d', '%d', '%d', '20%s');",
      bankers[i].name, bankers[i].cash/10000, bankers[i].cash/100%100, 
    ...
    {
      sprintf(query,"UPDATE bmembers SET g=%d, s=%d, c=%d, ldate='20%s' WHERE name='%s';",
      bankers[i].cash/10000, (bankers[i].cash/100)%100, bankers[i].cash%100, 
  ...
  for (i=0; i<=numranks; i++)
  {
    ...
    if (asd<=0) 
    {
      strcat(link, "INSERT INTO `usercat` ( `id` , `name` , `rnkimg`");
    ...
    {
      strcat(link, "UPDATE `usercat` SET `name`='");
      strcat(link, ranks[i]);
