...
L:RegisterTranslations("koKR", function() return {
	...
	["%s has been defeated"] = "<%s> ??????.",     -- "<boss> has been defeated"
	["%s have been defeated"] = "<%s> ??????.",    -- "<bosses> have been defeated"

	-- AceConsole strings
	["Bosses"] = "???",
	["Options for boss modules."] = "?? ?? ??",
	["Options for bosses in %s."] = "%s ? ???? ?? ??", -- "Options for bosses in <zone>"
	["Options for %s (r%s)."] = "%s? ?? ??(r%s).",     -- "Options for <boss> (<revision>)"
	["Plugins"] = "?????",
	["Options for plugins."] = "???? ??",
	["Extras"] = "??",
	["Options for extras."] = "?? ??.",
	["Active"] = "???",
	["Activate or deactivate this module."] = "??? ?? ?? ??",
	["Reboot"] = "???",
	["Reboot this module."] = "?? ???",
	["Debugging"] = "???",
	["Show debug messages."] = "??? ??? ??",
...
BigWigs.revision = tonumber(string.sub("$Revision: 8 $", 12, -3))
...
function BigWigs:Frosty()
        BigWigsThaddiusArrows:Direction("Froasty")
        PlaySoundFile("Interface\\AddOns\\BigWigs\\Sounds\\Frosty.mp3")
end