...
function BigWigsLoatheb:Sporespawnstart()
		        self:GetSubGroupID()
                        ...
                        self:ScheduleEvent("bwloathebsporespawnone", self.Sporespawnone, 106, self)
			self:TriggerEvent("BigWigs_StartBar", self, L["sporespawnbar1"], 15, "Interface\\Icons\\Inv_Mushroom_02")
...
function BigWigsLoatheb:Sporespawnone()
	                self:ScheduleRepeatingEvent("bwloathebsporespawntwo", self.Sporespawntwo, 104, self)
...
function BigWigsLoatheb:Cursesstart()
	                self:ScheduleRepeatingEvent("bwloathebcurses", self.Curses, 30, self)
end
