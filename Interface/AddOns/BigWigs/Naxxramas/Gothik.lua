...
function BigWigsGothik:CHAT_MSG_MONSTER_YELL( msg )
	...
	elseif msg == L["inroomtrigger"] then
		...
		self:TriggerEvent("BigWigs_StartBar", self, L["jumpbartext"], 20, "Interface\\Icons\\Ability_Warrior_Charge")
                self:ScheduleRepeatingEvent("bwgothikjump", self.Jump, 20, self)
