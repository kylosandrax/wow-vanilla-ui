...
function simpleMinimap_Movers:OnInitialize()
	...
	self.framesDefault = {
		QuestWatchFrame = { anchor=MinimapCluster, point="TOPRIGHT", rpoint="BOTTOMRIGHT", x=149.2982707379063, y=831.1131935915602 },
		DurabilityFrame = { anchor=MinimapCluster, point="TOPRIGHT", rpoint="BOTTOMRIGHT", x=667.8527523377825, y=481.1604507497724 },
		QuestTimerFrame = { anchor=MinimapCluster, point="TOPRIGHT", rpoint="BOTTOMRIGHT", x=105.9994187129856, y=835.0082231377395 },
		smmCaptureMover = { anchor=MinimapCluster, point="TOPRIGHT", rpoint="BOTTOMRIGHT", x=347.7681045776809, y=269.8505454152094 }
	}
