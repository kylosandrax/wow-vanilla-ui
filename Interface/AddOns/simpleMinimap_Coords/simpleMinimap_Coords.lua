...
function simpleMinimap_Coords:OnInitialize()
	...
	self.defaults = { enabled=true, position=3, backdrop=false, border=false, scale=0.65, alpha=1, fontR=0.8196078431372549, fontG=0.8196078431372549, fontB=0.8196078431372549, time=1 }
	self.options = {
