...
local backgrounds = {["Interface\\AddOns\\!ViroUi\\Textures\\FuBar"] = L["Default"]}
...
local function GetBackground()
	return backgrounds[FuBar.db.profile.skin] and FuBar.db.profile.skin or "Interface\\AddOns\\!ViroUI\\Textures\\FuBar"
end
