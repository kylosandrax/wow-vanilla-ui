...
function Powa_CreateTimer()
    for i = 1, 4 do
        if (Powa_Timer[i]) then
            ...
            Powa_timertex[i]:SetTexture("Interface\\Addons\\PowerAuras\\Assets\\Timers.tga");
        end
    end
...
function Powa_DisplayAura(FNum)
    ...
    if (Powa_FramesVisibleTime[FNum] == 0) then  -- si pas en cours
        ...
        Powa_textures[FNum]:SetTexture("Interface\\Addons\\PowerAuras\\Assets\\Auras\\Aura"..PowaSet[FNum].texture..".tga");
    ...
    Powa_textures[SecondeAura]:SetTexture("Interface\\Addons\\PowerAuras\\Assets\\Auras\\Aura"..PowaSet[FNum].texture..".tga");
...
function Powa_InitPage()
    ...
    getglobal("AuraTexture"):SetTexture("Interface\\Addons\\PowerAuras\\Assets\\Auras\\Aura"..PowaSet[CurrentAura].texture..".tga");
...
function PowaBarAuraTextureSliderChanged()
    ...
    getglobal("AuraTexture"):SetTexture("Interface\\Addons\\PowerAuras\\Assets\\Auras\\Aura"..SliderValue..".tga");
    getglobal("AuraTexture"):SetVertexColor(PowaSet[CurrentAura].r,PowaSet[CurrentAura].g,PowaSet[CurrentAura].b);
