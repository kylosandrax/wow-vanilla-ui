...
QST_QuestLog = {
	...
	[106] = {
		...
		["qLevel"] = 52,
		["qItems"] = {
			[1] = "Skeletal Flayer slain: 10/10",
			[2] = "Slavering Ghoul slain: 10/10",
		},
		["qNote"] = "",
		["qMoney"] = 22500,
		["qNPC"] = {
	...
	[115] = {
		...
		["qLevel"] = 55,
		["qItems"] = {
			[1] = "Dalson's Tears Cauldron Key: 0/1",
		},
		["qNote"] = "",
		["qMoney"] = 0,
		["qNPC"] = {
	...
	[116] = {
		...
		["qDesc"] = "Attention, heroes of the Alliance!  The silithid menace has been left unchecked for too long.  Unfettered by any real opposition, they've been preparing all this time for a large-scale expansion.  \n\nCenarion Circle forces are gathering in Silithus to take the fight to these wretched creatures and all able-bodied adventurers are hereby called to join us!\n\nDon't wait until it's too late!  Aid us in the defense of Azeroth! Report to Windcaller Proudhorn at Cenarion Hold for specific instructions!",
		["qZone"] = "Ironforge",
	...
	[122] = {
		...
		["qLevel"] = 60,
		["qItems"] = {
			[1] = "Encrypted Twilight Text: 10/10",
		},
		["qNote"] = "",
		["qMoney"] = 54000,
		["qNPC"] = {
	...
	[124] = {
		...
		["qDesc"] = "Blasted!  The antidote didn't work.  Noggle must've been stung by one of the stronger creatures in the far south.\n\nI'm going to need you to go there and get me some more samples, Ryvok.  The good news is that since their poison is stronger I won't require as many.  The bad news is that there are more kinds of poisonous creatures crawling around the southern area so you'll have to draw from more sources.",
		["qZone"] = "Silithus",
		["qItems"] = {
			[1] = "Stonelash Flayer Stinger: 0/3",
			[2] = "Stonelash Pincer Stinger: 0/3",
			[3] = "Rock Stalker Fang: 0/3",
		},
