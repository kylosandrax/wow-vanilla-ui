...
QST_QuestLog = {
	...
	[127] = {
		["qLogged"] = 1444845897,
		["qIndex"] = 16,
		["qTitle"] = "To Show Due Judgment",
		["qDesc"] = "With my blessings, take the censer.  I myself have used it in several exorcisms, and it should serve you well for the arduous tasks that lie ahead.\n\nReturn now to Lord Grayson Shadowbreaker in Stormwind, Ryvok.  Your quest continues with him.",
		["qArea"] = "Unknown",
		["qObj"] = "Return the Exorcism Censer to Lord Grayson Shadowbreaker in the Cathedral District of Stormwind.",
		["qPlayer"] = {
			["Ryvok of Warsong [12x] Blizzlike"] = {
				["qStatus"] = "|cFF00FF19Completed",
			},
	...
	[137] = {
		["qLogged"] = 1444851239,
		["qIndex"] = 25,
		["qTitle"] = "Araj's Scarab",
		["qDesc"] = "Araj the Summoner lords over Andorhal from the ruined city's heart.  We know that he was the former leader of Scholomance before claiming the city as his own.  To finish the key, we will need his signet - called a scarab - mounted as the head of the key.\n\nMake your way into the heart of Andorhal, and break his hold on the city now that he is drawn into the open.  Once destroyed, seize his scarab from his fallen phylactery!\n\nThe Key to Scholomance awaits, Ryvok!",
		["qZone"] = "Western Plaguelands",
		["qObj"] = "Destroy Araj the Summoner and bring Araj's Scarab to Alchemist Arbington at Chillwind Point, Western Plaguelands.",
		["qTag"] = "Elite",
		["qPlayer"] = {
			["Ryvok of Warsong [12x] Blizzlike"] = {
				["qStatus"] = "|cFF00FF19Completed",
